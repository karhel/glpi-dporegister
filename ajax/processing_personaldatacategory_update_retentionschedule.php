 ...
 */
 ...
 if (strpos($_SERVER['PHP_SELF'], 
    "processing_personaldatacategory_update_retentionschedule.php")) {
 ...
 if($_POST['checked'] != '1') {
    ...
    // Show the retention schedules inputs (html)
    PluginDporegisterProcessing_PersonalDataCategory::showRetentionScheduleInputs();
}